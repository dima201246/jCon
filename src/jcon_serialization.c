...
jsonErr_t jsonAddStr(jsonObj_t **_obj_json, const char *_str_path, const char *_str_key, const char *_str_value) {
	...
	if (_str_key == NULL)
	{
		return __jsonAdd(_obj_json, _str_path, _str_key, 0, (const void *)_str_value, strlen(_str_value), 0, JSON_VALUE_STR);
	}
...
jsonErr_t jsonAddObject(jsonObj_t **_obj_json, const char *_str_path, const char *_str_key) {
	if (_str_key == NULL)
	{
		return __jsonAdd(_obj_json, _str_path, _str_key, 0, NULL, 0, 0, JSON_VALUE_OBJECT);
	}
...
jsonErr_t jsonAddNum(jsonObj_t **_obj_json, const char *_str_path, const char *_str_key, long long _int_value) {
	...
	if (_str_key == NULL)
	{
		return __jsonAdd(_obj_json, _str_path, _str_key, 0, (const void *)buf, (strlen(buf) + 1), 0, JSON_VALUE_NUMBER);
	}
...
jsonErr_t jsonAddNumByStr(jsonObj_t **_obj_json, const char *_str_path, const char *_str_key, const char *_str_value) {
	...
	if (_str_key == NULL)
	{
		return __jsonAdd(_obj_json, _str_path, _str_key, 0, (const void *)_str_value, (strlen(_str_value) + 1), 0, JSON_VALUE_NUMBER);
	}
...
jsonErr_t jsonAddArray(jsonObj_t **_obj_json, const char *_str_path, const char *_str_key) {
	if (_str_key == NULL)
	{
		return __jsonAdd(_obj_json, _str_path, _str_key, 0, NULL, 0, 0, JSON_VALUE_ARRAY);
	}
...
jsonErr_t jsonAddBool(jsonObj_t **_obj_json, const char *_str_path, const char *_str_key, uint8_t _bool_value) {
	if (_str_key == NULL)
	{
		return __jsonAdd(_obj_json, _str_path, _str_key, 0, (const void *)&_bool_value, 1, 0, JSON_VALUE_BOOL);
	}
...
jsonErr_t jsonAddNull(jsonObj_t **_obj_json, const char *_str_path, const char *_str_key) {
	if (_str_key == NULL)
	{
		return __jsonAdd(_obj_json, _str_path, _str_key, 0, NULL, 0, 0, JSON_VALUE_NULL);
	}
...
jsonErr_t jsonAddObjectCpy(jsonObj_t **_obj_json, const char *_str_path, const jsonObj_t *_obj_json_copied) {
	jsonObj_t *ptr_obj_json = NULL;
	jsonErr_t err_json = JSON_OK;

	if (_obj_json_copied == NULL)
	{
		return JSON_ERR_ARGS;
	}

	ptr_obj_json = jsonDup(_obj_json_copied);

	if (_obj_json_copied->__str_key == NULL)
	{
		err_json = __jsonAdd(_obj_json, _str_path, NULL, 0, ptr_obj_json->__value, ptr_obj_json->__size_value, 0, ptr_obj_json->__type);
	}
	else
	{
		err_json = __jsonAdd(_obj_json, _str_path, ptr_obj_json->__str_key, strlen(ptr_obj_json->__str_key), \
			ptr_obj_json->__value, ptr_obj_json->__size_value, 0, ptr_obj_json->__type);
	}

	if (err_json == JSON_OK)
	{
		free(ptr_obj_json->__value);
		free((void *)ptr_obj_json->__str_key);
		free((void *)ptr_obj_json);
	}
	else
	{
		jsonFree(ptr_obj_json);
	}
